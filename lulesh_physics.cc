...
Domain::InitializeLuleshData() {
  ...
  *--------------------------------------------------------------------------*/
  ...
  //------- begin wrapping with Conduit here -------//
  {
    ...
    m_ascent_node["state/time"].set_external(&domain->totalTime);
    m_ascent_node["state/cycle"].set_external(&iterations);
    int32_t chare_idx = thisIndex.z*chareDimY*chareDimX + thisIndex.y*chareDimX + thisIndex.x;
    m_ascent_node["state/domain_id"] = chare_idx;
    m_ascent_node["state/glob_dom"] = chareDimX*chareDimY*chareDimZ;
    m_ascent_node["state/info"] = "In Situ DAV from LULESH Shock-Hydro Proxy Simulation";

    m_ascent_node["coordsets/coords/type"] = "explicit";
    m_ascent_node["coordsets/coords/values/x"].set_external(domain->m_x);
    m_ascent_node["coordsets/coords/values/y"].set_external(domain->m_y);
    m_ascent_node["coordsets/coords/values/z"].set_external(domain->m_z);

    m_ascent_node["topologies/mesh/type"] = "structured";
    m_ascent_node["topologies/mesh/coordset"] = "coords";

    m_ascent_node["topologies/mesh/elements/dims/i"] = blockDimX;
    m_ascent_node["topologies/mesh/elements/dims/j"] = blockDimY;
    m_ascent_node["topologies/mesh/elements/dims/k"] = blockDimZ;

    m_ascent_node["fields/e/association"] = "element";
    m_ascent_node["fields/e/topology"]    = "mesh";
    m_ascent_node["fields/e/values"].set_external(domain->m_e);

    m_ascent_node["fields/p/association"] = "element";
    m_ascent_node["fields/p/topology"]    = "mesh";
    m_ascent_node["fields/p/values"].set_external(domain->m_p);

    m_ascent_node["fields/v/association"] = "element";
    m_ascent_node["fields/v/topology"]    = "mesh";
    m_ascent_node["fields/v/values"].set_external(domain->m_v);

    m_ascent_node["fields/q/association"] = "element";
    m_ascent_node["fields/q/topology"]    = "mesh";
    m_ascent_node["fields/q/values"].set_external(domain->m_q);

    m_ascent_node["fields/velocity/association"] = "vertex";
    m_ascent_node["fields/velocity/topology"]    = "mesh";
    m_ascent_node["fields/velocity/values/u"].set_external(domain->m_xd);
    m_ascent_node["fields/velocity/values/v"].set_external(domain->m_yd);
    m_ascent_node["fields/velocity/values/w"].set_external(domain->m_zd);

    m_ascent_node["fields/acceleration/association"] = "vertex";
    m_ascent_node["fields/acceleration/topology"]    = "mesh";
    m_ascent_node["fields/acceleration/values/u"].set_external(domain->m_xdd);
    m_ascent_node["fields/acceleration/values/v"].set_external(domain->m_ydd);
    m_ascent_node["fields/acceleration/values/w"].set_external(domain->m_zdd);

    m_ascent_node["fields/forces/association"] = "vertex";
    m_ascent_node["fields/forces/topology"]    = "mesh";
    m_ascent_node["fields/forces/values/u"].set_external(domain->m_fx);
    m_ascent_node["fields/forces/values/v"].set_external(domain->m_fy);
    m_ascent_node["fields/forces/values/w"].set_external(domain->m_fz);

    m_ascent_node["fields/nodal_mass/association"] = "vertex";
    m_ascent_node["fields/nodal_mass/topology"]    = "mesh";
    m_ascent_node["fields/nodal_mass/values"].set_external(domain->m_nodalMass);
  }
